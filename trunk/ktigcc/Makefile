...
# Generated by qmake (1.07a) (Qt 3.3.4) on: Tue Jan 10 17:15:12 2006
# Project:  ktigcc.pro
# Template: app
...
LINK     = g++
LFLAGS   = 
LIBS     = $(SUBLIBS) -L$(QTDIR)/lib -L/usr/X11R6/lib -lktexteditor -lqassistantclient -L/usr/src/build/567883-i386/BUILD/qt-x11-free-3.3.4/lib -lmng -ljpeg -lpng -lz -lSM -lICE -ldl -lpthread -lqt-mt -lXext -lX11 -lm
AR       = ar cqs
RANLIB   = 
MOC      = $(QTDIR)/bin/moc
UIC      = $(QTDIR)/bin/uic
...
.obj/tpr.o: tpr.cxx 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/tpr.o tpr.cxx
