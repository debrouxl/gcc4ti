...
| PreOs ("Kernel v6") Program Header

	.xdef __kernel_program_header_AND___preos_headers,__kernel_entry_point,__kernel_fixed_header_end,__bss_handle
...
| __ld_insert) is as follows (see below for the explanation of "Index" and
