...
#endif
typedef unsigned short EStackDisplacement;
...
#endif
#if MIN_AMS>=310
,ROOT_TAG=0x57,EXPRIO_TAG=0x58,IMPDIF_TAG=0x59,STDEVPOP_TAG=0x5A,ISVAR_TAG=0x5B,ISLOCKED_TAG=0x5C,ISARCHIV_TAG=0x5D,GRAD_TAG=0x5E,TO_GRAD_TAG=0x5F,TO_RAD_TAG=0x60,TO_LN_TAG=0x61,TO_LOGBASE_TAG=0x62
#endif
...
enum FLOATTABIndexes{FPI_TWOPI=0,FPI_ONEPI,FPI_PIDIV2,FPI_PIDIV4,FPI_360,FPI_180,FPI_90,FPI_45,FPI_180DIVPI,FPI_PIDIV180,FPI_0,FPI_PT001,FPI_PT1,FPI_PIDIV24,FPI_PT5,FPI_PT9,FPI_1,FPI_MINUS1,FPI_SQRRT2,FPI_2,FPI_3,FPI_2PI12,FPI_10,FPI_MINUS10,FPI_12,FPI_14,FPI_20,FPI_70,FPI_BIGGEST,FPI_NEGBIGGEST,FPI_16000,FPI_MINUS16000,FPI_32767,FPI_MINUS32768,FPI_65535,FPI_1E14,FPI_INVALID,FPI_LOGE,FPI_POS0,FPI_NEG0,FPI_POSINF,FPI_NEGINF,FPI_UNSINF};
...
#endif
#if MIN_AMS>=300
,SENDCALC_TWOARG_ITAG=0x9C,GETCALC_TWOARG_ITAG=0x9D
#endif
#if MIN_AMS>=310
,DELTYPE_ITAG=0x9E,DATA2MAT_ITAG=0x9F,MAT2DATA_ITAG=0xA0
#endif
...
#define push_e ({((void(*CALLBACK)(void))(primary_tag_list[EXP_TAG].tag_proc))();})
#define push_END_TAG _rom_call(void,(void),263)
#define push_i ({((void(*CALLBACK)(void))(primary_tag_list[IM_TAG].tag_proc))();})
...
#define push_exact0 _rom_call(void,(void),4EC)
#define push_exact1 _rom_call(void,(void),4F2)
#define push_exact_minus1 _rom_call(void,(void),4ED)
#define push_half _rom_call(void,(void),4EB)
#define push_long_to_integer _rom_call(void,(long),4E3)
#define push_minus1 _rom_call(void,(void),4EE)
#define push_minus_half _rom_call(void,(void),4F0)
#define push_negate_quantum_as_negint _rom_call(void,(ESQ),4F1)
#define push_no_solution_found_string _rom_call(void,(void),4CC)
...
#define divide_top ({__need_in_use_bit;_rom_call(void,(CESI),527);})
...
#define or_onto_top _rom_call(void,(CESI),57B)
...
#define raise_to_top ({__need_in_use_bit;_rom_call(void,(CESI),529);})
...
#define times_top ({__need_in_use_bit;_rom_call(void,(CESI),522);})
#if MIN_AMS>=204
